...
export class CartListService {
  ...
  private calculateTotalSum(): void {
    this.cartProducts$$
      ...
      // Думаю, что такой вариант не очень правильный, так как в каждом методе
      // создается подписка, но никто никак ею не управляет.
      // Конечно, поток конечный, там везде есть take(1)
      // но я бы подумал по возможности о каком-то альтернативном решении.
      .subscribe();
  }
}
